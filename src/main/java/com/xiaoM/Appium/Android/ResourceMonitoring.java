...
public class ResourceMonitoring {
    ...
    public void startMonitoring(String DeviceName, String TestCategory) throws Exception {
        try {
            ...
            String MenPath = BeginAppScript.ProjectPath + "/test-result/MonitorResoure/Mem/" + DeviceName + ".txt";
            String NetPath = BeginAppScript.ProjectPath + "/test-result/MonitorResoure/Net/" + DeviceName + ".txt";
            ...
            CpuThread cpuThread = new CpuThread(BeginAppScript.PackageName, DeviceBase[2][2], DeviceName); // CPU监控线程1
            MemThread memThread = new MemThread(BeginAppScript.PackageName, DeviceBase[2][2], DeviceName);//内存监控线程2
    ...
    public void stopMonitoring(String DeviceName, String TestCategory) throws Exception {
        ...
        String[] Men;
        String[] Cpu;
        AdbMoudle.adbClearCache(BeginAppScript.PackageName, DeviceName);
        AdbMoudle.forceStop(BeginAppScript.PackageName, DeviceName);
        String appPackageActivity = BeginAppScript.PackageName + "/" + BeginAppScript.Activity;
